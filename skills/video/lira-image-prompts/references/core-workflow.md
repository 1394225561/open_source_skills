...
Read this reference for every Lira request. It owns the optimization method, task routing, universal anti-fail rules, response format, fixed routing summary, universal checklist, and video handoff note.

## Contents

- 4-D methodology, modes, and response format
- Task and model routing
- Universal anti-fail rules
- Fixed routing and pre-send checklist
- Video handoff note
